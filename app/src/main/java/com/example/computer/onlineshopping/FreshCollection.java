...
public class FreshCollection extends AppCompatActivity  implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fresh_collection);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    FreshAdapter freshAdapter=new FreshAdapter(FreshCollection.this,jsonArray);
                    gv_dashboard.setAdapter(freshAdapter);
                    gv_dashboard.setOnItemClickListener(FreshCollection.this);
            ...
            public void onErrorResponse(VolleyError error){
                ...
                Toast.makeText(FreshCollection.this, "Error is there!", Toast.LENGTH_LONG).show();
                progressDialog.dismiss();
            }


        });
        progressDialog=new ProgressDialog(FreshCollection.this);
        RequestQueue requestQueue = Volley.newRequestQueue(FreshCollection.this);
    ...
    public void onItemClick(AdapterView<?>adapterView, View view, int position, long i) {
        try {
            ...
            Intent intent = new Intent(FreshCollection.this, FreshPreview.class);
